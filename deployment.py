...
class Deployment(AgentConfig, EnvConfig):
    def __init__(self):
        ...
        step = 95000
        self.kkk = 4
        self.dqn_network.load_state_dict(torch.load('result'+str(self.kkk)+'/dqn_step_'+str(step)+'.pth'))
        self.predictor_network.load_state_dict(torch.load('result'+str(self.kkk)+'/pred_step_'+str(step)+'.pth'))
        self.seq2seq.load_state_dict(torch.load('result'+str(self.kkk)+'/encode_step_'+str(step)+'.pth'))
    ...
    def run(self):
        ...
        for i in range(400000):
            ...
            list1.append(next_state[0])
            list2.append(self.desired_pos)
            ...
            if terminal:
                ...
                if max_step:
                    plt.savefig("./plot"+str(self.kkk)+"/plot_max_"+str(i)+'.png')
                else:
                    plt.savefig("./plot"+str(self.kkk)+"/plot_z_"+str(i)+'.png')
                plt.clf()
                list1 = []
                list2 = []
